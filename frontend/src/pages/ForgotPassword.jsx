          ...
          {step === 1 && (
            <>
              <div className="text-center p-4 pb-2">
                ...
                <p className="text-muted small">{t('forgot.subtitle')}</p>
              </div>
              <div className="p-4 pt-0">
                <form onSubmit={handleSendCode}>
                  ...
                  <Link to="/login" className="w-full mt-3 text-muted text-decoration-none small d-flex align-items-center justify-content-center gap-2">
          ...
          {step === 2 && (
            <>
              <div className="text-center p-4 pb-2">
                ...
                <p className="text-muted small">{t('forgot.codeSentTo')} <strong>{email}</strong></p>
              </div>
              <div className="p-4 pt-0">
                <form onSubmit={handleResetPassword}>
                  ...
                  <div className="text-center mt-3">
                    <Button variant="link" onClick={handleResend} disabled={resending} className="p-0 text-amber-600">
