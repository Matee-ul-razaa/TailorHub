...
const FIELD_LABELS = {
  coatLength: { en: 'Coat Length', ur: 'کوٹ کی لمبائی' },
  chest: { en: 'Chest', ur: 'سینہ (چھاتی)' },
  waist: { en: 'Waist', ur: 'کمر' },
  hip: { en: 'Hip', ur: 'کولہے (ہپ)' },
  shoulder: { en: 'Shoulder', ur: 'تیرہ (کندھا)' },
  sleeveLength: { en: 'Sleeve Length', ur: 'آستین (بازو)' },
  neck: { en: 'Neck', ur: 'گلا (کالر)' },
  pantLength: { en: 'Pant Length', ur: 'پینٹ کی لمبائی' },
  inseam: { en: 'Inseam', ur: 'ان سیم' },
  vestLength: { en: 'Vest Length', ur: 'واسکٹ لمبائی' },
  kameezLength: { en: 'Kameez Length', ur: 'قمیض کی لمبائی' },
  shalwarLength: { en: 'Shalwar Length', ur: 'شلوار لمبائی' },
  jacketLength: { en: 'Waistcoat Length', ur: 'واسکٹ لمبائی' },
  shalwarPancha: { en: 'Pancha', ur: 'پانچہ' },
  thigh: { en: 'Thigh', ur: 'ران (تھائی)' },
  bottomWidth: { en: 'Bottom Width', ur: 'باٹم کی چوڑائی' },
  pantInseam: { en: 'Pant Inseam', ur: 'پینٹ ان سیم' },
  kurtaLength: { en: 'Kurta Length', ur: 'کرتہ کی لمبائی' },
  pajamaLength: { en: 'Pajama Length', ur: 'پاجامہ لمبائی' },
};
...
const GARMENT_FIELDS = {
  'pent-coat': {
    ...
    tutorial2LabelUr: 'واسکٹ کی ویڈیو',
    fields: [
      { key: 'coatLength', label: 'Coat Length', labelUr: 'کوٹ کی لمبائی', unit: 'in' },
      { key: 'chest', label: 'Chest', labelUr: 'سینہ (چھاتی)', unit: 'in' },
      { key: 'waist', label: 'Waist', labelUr: 'کمر', unit: 'in' },
      { key: 'hip', label: 'Hip', labelUr: 'کولہے (ہپ)', unit: 'in' },
      { key: 'shoulder', label: 'Shoulder', labelUr: 'تیرہ (کندھا)', unit: 'in' },
      { key: 'sleeveLength', label: 'Sleeve Length', labelUr: 'آستین (بازو)', unit: 'in' },
      { key: 'neck', label: 'Neck', labelUr: 'گلا (کالر)', unit: 'in' },
      { key: 'pantLength', label: 'Pant Length', labelUr: 'پینٹ کی لمبائی', unit: 'in' },
      { key: 'inseam', label: 'Inseam', labelUr: 'اندرونی لمبائی (ان سیم)', unit: 'in' },
      { key: 'vestLength', label: 'Vest Length', labelUr: 'واسکٹ کی لمبائی', unit: 'in' },
    ],
  },
  'shalwar-kameez': {
    ...
    tutorial2LabelUr: 'واسکٹ کی ویڈیو',
    fields: [
      { key: 'kameezLength', label: 'Kameez / Kurta Length', labelUr: 'قمیض / کرتہ کی لمبائی', unit: 'in' },
      { key: 'chest', label: 'Chest', labelUr: 'سینہ (چھاتی)', unit: 'in' },
      { key: 'shoulder', label: 'Shoulder', labelUr: 'تیرہ (کندھا)', unit: 'in' },
      { key: 'sleeveLength', label: 'Sleeve Length', labelUr: 'آستین (بازو)', unit: 'in' },
      { key: 'shalwarLength', label: 'Shalwar / Pajama Length', labelUr: 'شلوار / پاجامہ لمبائی', unit: 'in' },
      { key: 'waist', label: 'Waist', labelUr: 'کمر', unit: 'in' },
      { key: 'hip', label: 'Hip', labelUr: 'کولہے (ہپ)', unit: 'in' },
      { key: 'inseam', label: 'Inseam', labelUr: 'اندرونی لمبائی (ان سیم)', unit: 'in' },
      { key: 'jacketLength', label: 'Waistcoat Length', labelUr: 'واسکٹ کی لمبائی', unit: 'in' },
    ],
  },
};
        ...
        <div className="th-card-static p-4 mb-4 scroll-anim">
          ...
          {loadingAppointments ? (
            <div className="text-center py-4">
              ...
              <p className="text-muted small mb-0">{t('measurements.loadingAppointments')}</p>
            </div>
          ) : myAppointments.length === 0 ? (
            <div className="text-center py-4 px-3 border rounded-3 bg-light bg-opacity-50 text-muted">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowBooking(true)}>
                <CalendarDays size={14} className={isUrdu ? "ms-1" : "me-1"} />
              ...
              {myAppointments.map(appt => {
                const statusMeta = {
                  pending: {
                    ...
                    icon: <Clock size={14} className={isUrdu ? "ms-1" : "me-1"} />,
                  ...
                  approved: {
                    ...
                    icon: <CheckCircle2 size={14} className={isUrdu ? "ms-1" : "me-1"} />,
                  ...
                  rejected: {
                    ...
                    icon: <AlertCircle size={14} className={isUrdu ? "ms-1" : "me-1"} />,
                ...
                return (
                  <div key={appt.id} className="col-md-6">
                    <div className={`p-3 rounded-3 border h-100 d-flex flex-column justify-content-between bg-white shadow-sm ${meta.border} border-opacity-25`}>
                      <div>
                        <div className={`d-flex align-items-center justify-content-between gap-2 mb-2 ${isUrdu ? 'flex-row-reverse' : ''}`}>
                        ...
                        <div className={`text-muted small mb-2 d-flex align-items-center gap-2 ${isUrdu ? 'flex-row-reverse' : ''}`}>
                          <Clock size={13} />
                        ...
                        {appt.notes && (
                          <div className={`small text-muted fst-italic mb-2 bg-light p-2 rounded ${isUrdu ? 'text-end' : ''}`}>
                            "{appt.notes}"
                          </div>
                        )}
                      </div>
                      <div className={`mt-2 p-2 rounded small ${appt.status === 'approved' ? 'bg-success bg-opacity-10 text-success' : appt.status === 'pending' ? 'bg-warning bg-opacity-10 text-dark' : 'bg-light text-muted'} ${isUrdu ? 'text-end' : ''}`}>
                        {meta.desc}
                        {appt.admin_notes && (
                          <div className="mt-1 fw-medium">
                            {t('measurements.note')} {appt.admin_notes}
                          </div>
                        )}
                      </div>
                    </div>
            ...
            <div className="th-card-static p-0 anim-scale-in" style={{ maxWidth: 440, width: '100%', backgroundColor: 'var(--th-card-bg)' }} dir={isUrdu ? 'rtl' : 'ltr'}>
              ...
              <div className="p-4 pt-2 d-flex flex-column gap-3">
                ...
                <div>
                  ...
                  <input
                    className="th-input"
                    placeholder={isUrdu ? "مثلاً شیروانی یا پرنس کوٹ کی پیمائش درکار ہے..." : "e.g. Need measurements for Sherwani / Prince Coat..."}
          ...
          <div className="col-lg-8">
                  ...
                  <div key={m.id} className="th-card-static p-4 hover-lift scroll-anim" style={{ transitionDelay: `${i * 0.08}s` }}>
                    <div className="d-flex align-items-start justify-content-between">
                      <div className={isUrdu ? 'text-end' : ''}>
                        ...
                        <h6 className="fw-semibold mt-1 mb-0">{m.label || (isUrdu ? GARMENT_FIELDS[m.garmentType]?.labelUr : GARMENT_FIELDS[m.garmentType]?.label) || m.garmentType}</h6>
                        <p className="text-muted small mb-0">{t('measurements.type')}: {(isUrdu ? GARMENT_FIELDS[m.garmentType]?.labelUr : GARMENT_FIELDS[m.garmentType]?.label) || m.garmentType} · {t('measurements.updated')}: {new Date(m.updatedAt).toLocaleDateString(isUrdu ? 'ur-PK' : undefined)}</p>
                      </div>
                        ...
                        <div key={key} className="col-sm-4 col-6">
                          <div className={`d-flex justify-content-between rounded-2 px-2 py-1 ${isUrdu ? 'flex-row-reverse' : ''}`} style={{ background: '#f1f3f5', fontSize: '0.82rem' }}>
                            <span className="text-muted text-capitalize">
                              {isUrdu ? (FIELD_LABELS[key]?.ur || key) : (FIELD_LABELS[key]?.en || key.replace(/([A-Z])/g, ' $1').trim())}
                            </span>
            ...
            {showForm && garment && (
              <div className="th-card-static p-4 mt-4 anim-fade-up" style={{ borderColor: 'rgba(230,126,34,0.3)' }}>
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <h5 className="fw-semibold mb-0">{editingId ? t('measurements.edit') : t('measurements.new')} {isUrdu ? garment.labelUr : garment.label} {t('nav.measurements')}</h5>
                  <div className="d-flex align-items-center gap-3">
                    ...
                    {garment.tutorial2 && (
                      <Button
                        ...
                        className="p-0 text-amber-600 d-flex align-items-center gap-1 hover-lift"
                      >
                        <PlayCircle size={16} /> <span className="small fw-medium">{isUrdu ? garment.tutorial2LabelUr : garment.tutorial2Label}</span>
                      </Button>
                    )}
                ...
                <div className="d-flex flex-column gap-3">
                  <div>
                    ...
                    <input
                      className="th-input"
                      placeholder={isUrdu ? "مثلاً عید ۲۰۲۶ کا سوٹ" : "e.g. Eid 2026 Suit"}
                      value={formLabel}
                  ...
                  <div className="row g-3">
                    {garment.fields.map(field => {
                      ...
                      const displayFieldLabel = isUrdu ? (field.labelUr || field.label) : field.label;
                      ...
                      return (
                        <div key={field.key} className="col-sm-6">
                          <div className={`d-flex align-items-center justify-content-between mb-1 ${isUrdu ? 'flex-row-reverse' : ''}`}>
                            <label className="th-label small mb-0">{displayFieldLabel} ({isUrdu ? 'انچ' : field.unit})</label>
                          </div>
                          <div className="position-relative">
                            <input
                              ...
                              placeholder={isUrdu ? `${displayFieldLabel} درج کریں` : `Enter ${field.label.toLowerCase()}`}
              ...
              <div className="d-flex flex-column gap-2">
                {Object.entries(GARMENT_FIELDS).map(([key, val]) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="fw-medium mb-0">{isUrdu ? val.labelUr : val.label}</p>
