...
(({ className, ...props }, ref) => (
  React.createElement(AlertDialogPrimitive.Title, { ref: ref, className: cn("text-lg font-semibold", className), ...props} )
));
...
(({ className, ...props }, ref) => (
  React.createElement(AlertDialogPrimitive.Description, { ref: ref, className: cn("text-sm text-muted-foreground", className), ...props} )
));
...
(({ className, ...props }, ref) => (
  React.createElement(AlertDialogPrimitive.Action, { ref: ref, className: cn(buttonVariants(), className), ...props} )
));
