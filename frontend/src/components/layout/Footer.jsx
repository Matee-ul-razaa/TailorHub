      ...
      <div className="container py-4">
        <div className="row g-5">
          ...
          <div className="col-sm-6 col-lg-2 text-center text-lg-start" dir={isUrdu ? 'rtl' : 'ltr'}>
            ...
            <div className="d-flex flex-column gap-3 small">
              <Link to="/catalog?category=shirts" className="text-decoration-none text-white-50 hover-lift">{isUrdu ? 'فارمل شرٹس' : 'Formal Shirts'}</Link>
              <Link to="/catalog?category=t-shirts" className="text-decoration-none text-white-50 hover-lift">{isUrdu ? 'ٹی شرٹس اور پولوز' : 'T-Shirts & Polos'}</Link>
              <Link to="/catalog?category=pants" className="text-decoration-none text-white-50 hover-lift">{isUrdu ? 'پینٹس اور ٹراؤزرز' : 'Pants & Trousers'}</Link>
              <Link to="/catalog?category=traditional" className="text-decoration-none text-white-50 hover-lift">{isUrdu ? 'روایتی لباس' : 'Traditional Wear'}</Link>
            </div>
          </div>
