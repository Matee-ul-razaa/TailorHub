...
const SidebarHeader = React.forwardRef(({ className, ...props }, ref) => {
  return React.createElement('div', { ref: ref, 'data-sidebar': "header", className: cn("flex flex-col gap-2 p-2", className), ...props} );
});
SidebarHeader.displayName = "SidebarHeader";

const SidebarFooter = React.forwardRef(({ className, ...props }, ref) => {
  return React.createElement('div', { ref: ref, 'data-sidebar': "footer", className: cn("flex flex-col gap-2 p-2", className), ...props} );
});
...
const SidebarGroupContent = React.forwardRef(
  ({ className, ...props }, ref) => (
    React.createElement('div', { ref: ref, 'data-sidebar': "group-content", className: cn("w-full text-sm", className), ...props} )
  ),
);
SidebarGroupContent.displayName = "SidebarGroupContent";

const SidebarMenu = React.forwardRef(({ className, ...props }, ref) => (
  React.createElement('ul', { ref: ref, 'data-sidebar': "menu", className: cn("flex w-full min-w-0 flex-col gap-1", className), ...props} )
));
SidebarMenu.displayName = "SidebarMenu";

const SidebarMenuItem = React.forwardRef(({ className, ...props }, ref) => (
  React.createElement('li', { ref: ref, 'data-sidebar': "menu-item", className: cn("group/menu-item relative", className), ...props} )
));
...
const SidebarMenuSubItem = React.forwardRef(({ ...props }, ref) => (
  React.createElement('li', { ref: ref, ...props} )
));
