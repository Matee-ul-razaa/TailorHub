...
import { Package, LogIn, CheckCircle2, Scissors, Shirt, Truck, Box } from 'lucide-react';
    ...
    return (
      <Layout>
        <div className="container d-flex flex-column align-items-center justify-content-center gap-3 px-3 text-center" style={{ minHeight: '60vh' }}>
          ...
          <Link to="/login">
            <button className="btn btn-accent">{t('nav.login', 'Sign In')}</button>
          </Link>
        </div>
      </Layout>
    );
        ...
        <div className="d-flex flex-column gap-3">
          {visibleOrders.length === 0 && (
            <div className="d-flex flex-column align-items-center justify-content-center gap-3 py-5 text-center scroll-anim">
              ...
              <Link to="/catalog">
                <button className="btn btn-outline-secondary">{t('catalog.allProducts')}</button>
              </Link>
            </div>
          )}
