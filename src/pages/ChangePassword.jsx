          ...
          <div className="col-md-6 col-lg-5">
            <div className="th-card-static anim-scale-in p-4">
              ...
              <div className="text-center mb-4">
                ...
                <p className="text-muted small mb-0">Update your account password securely</p>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {confirmPassword.length > 0 && (
                  <div className="mb-3 d-flex align-items-center gap-1" style={{ fontSize: '0.75rem' }}>
                    {passwordsMatch
                      ? <><CheckCircle2 size={14} color="#22c55e" /><span style={{ color: '#22c55e' }}>Passwords match</span></>
                      : <><XCircle size={14} color="#ef4444" /><span style={{ color: '#ef4444' }}>Passwords do not match</span></>
                    }
                  </div>
                )}
