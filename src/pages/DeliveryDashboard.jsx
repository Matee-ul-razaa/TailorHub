...
import {
  ...
  PlayCircle, Loader2, ChevronDown, ChevronUp, History, AlertCircle,
} from 'lucide-react';
    ...
    <div className="th-card-static p-3 p-md-4 scroll-anim" dir={isUrdu ? 'rtl' : 'ltr'}>
      ...
      {order.items?.length > 0 && (
        <>
          <button
            type="button"
            className="btn btn-link btn-sm p-0 text-decoration-none small d-flex align-items-center gap-1 mb-2"
      ...
      >
              ...
              <OrderCard
                ...
                action={
                  <div className="d-flex flex-column gap-2">
                    <button
                      type="button"
                      className="btn btn-accent btn-sm d-flex align-items-center justify-content-center gap-1 w-100"
                    ...
                    {order.payment?.method === 'cod' && order.payment?.status !== 'completed' && (
                      <button
                        type="button"
                        className="btn btn-success btn-sm d-flex align-items-center justify-content-center gap-1 w-100"
            ...
            {pickups.map(order => (
              <OrderCard
                ...
                action={
                  <button
                    type="button"
                    className="btn btn-accent btn-sm d-flex align-items-center gap-1"
        ...
        {recentlyDelivered.length > 0 && (
          <section className="mb-4">
            <button
              type="button"
              className="btn btn-outline-secondary btn-sm d-flex align-items-center gap-2 scroll-anim"
