...
const GARMENT_FIELDS = {
  shirt: {
    ...
    fields: [
      ...
      { key: 'shoulder', label: 'Shoulder Width', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      ...
      { key: 'shirtLength', label: 'Shirt Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
  ...
  'shalwar-kameez': {
    ...
    fields: [
      { key: 'kameezLength', label: 'Kameez Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'chest', label: 'Chest', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'shoulder', label: 'Shoulder', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'sleeveLength', label: 'Sleeve Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'shalwarLength', label: 'Shalwar Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'shalwarPancha', label: 'Shalwar Pancha', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'waist', label: 'Waist', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
    ],
  },
  pant: {
    ...
    fields: [
      ...
      { key: 'inseam', label: 'Inseam', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'thigh', label: 'Thigh', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'pantLength', label: 'Pant Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'bottomWidth', label: 'Bottom Width', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
    ],
  },
  suit: {
    label: 'Suit',
    fields: [
      ...
      { key: 'shoulder', label: 'Shoulder', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'sleeveLength', label: 'Sleeve Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'jacketLength', label: 'Jacket Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'waist', label: 'Waist', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'hip', label: 'Hip', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'pantInseam', label: 'Pant Inseam', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
    ],
  },
  'kurta-pajama': {
    label: 'Kurta Pajama',
    fields: [
      { key: 'kurtaLength', label: 'Kurta Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'chest', label: 'Chest', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'shoulder', label: 'Shoulder', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'sleeveLength', label: 'Sleeve Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'pajamaLength', label: 'Pajama Length', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
      { key: 'waist', label: 'Waist', unit: 'in', tutorial: 'https://www.youtube.com/embed/O_gDvfG7iQM' },
    ],
  },
};
        ...
        <div className="th-card-static p-4 mb-4 scroll-anim">
          <div className="row g-3 align-items-end">
            ...
            <div className="col-sm-auto">
              <button className="btn btn-outline-secondary d-flex align-items-center gap-2 w-100" onClick={handleLookup}>
                <Ruler size={16} /> {t('measurements.load')}
              </button>
            </div>
            <div className="col-sm-auto">
              <button className="btn btn-outline-secondary d-flex align-items-center gap-2 w-100" onClick={() => setShowBooking(true)}>
          ...
          <div className="th-modal-overlay">
            <div className="th-card-static p-0 anim-scale-in" style={{ maxWidth: 440, width: '100%' }} dir={isUrdu ? 'rtl' : 'ltr'}>
              <div className="p-4 pb-2 d-flex align-items-center justify-content-between">
                ...
                <button className="btn p-0 border-0 lh-1" onClick={() => setShowBooking(false)}><X size={20} /></button>
              </div>
              <div className="p-4 pt-2 d-flex flex-column gap-3">
                ...
                <button className="btn btn-accent w-100" onClick={() => { toast.success('Appointment request submitted!'); setShowBooking(false); }}>
          ...
          <div className="th-modal-overlay">
            <div className="th-card-static p-4 anim-scale-in" style={{ maxWidth: 640, width: '100%' }}>
              <div className="d-flex align-items-center justify-content-between mb-3">
                ...
                <button className="btn p-0 border-0 lh-1" onClick={() => setTutorialUrl(null)}><X size={20} /></button>
              </div>
                    ...
                    <div className="d-flex align-items-start justify-content-between">
                      <div className={isUrdu ? 'text-end' : ''}>
                        <div className={`d-flex align-items-center gap-2 ${isUrdu ? 'flex-row-reverse' : ''}`}>
                          ...
                          <button onClick={() => copyCode(m.uniqueCode)} className="btn p-0 border-0 text-muted lh-1"><Copy size={14} /></button>
                        </div>
                      ...
                      <div className="d-flex gap-1">
                        <button className="btn btn-link text-muted p-1" onClick={() => startEdit(m)}><Edit3 size={16} /></button>
                        <button className="btn btn-link text-danger p-1" onClick={() => handleDelete(m.id)}><Trash2 size={16} /></button>
                      </div>
                    </div>
            ...
            {showForm && garment && (
              <div className="th-card-static p-4 mt-4 anim-fade-up" style={{ borderColor: 'rgba(230,126,34,0.3)' }}>
                <div className="d-flex align-items-center justify-content-between mb-3">
                  ...
                  <button className="btn p-0 border-0 lh-1" onClick={() => setShowForm(false)}><X size={20} /></button>
                </div>
                <div className="d-flex flex-column gap-3">
                  <div>
                        ...
                        <div key={field.key} className="col-sm-6">
                          <div className={`d-flex align-items-center justify-content-between ${isUrdu ? 'flex-row-reverse' : ''}`}>
                            ...
                            <button
                              ...
                              className="btn btn-link text-accent p-0 text-decoration-none d-flex align-items-center gap-1"
                  ...
                  <button className="btn btn-accent w-100 d-flex align-items-center justify-content-center gap-2" onClick={handleSave} disabled={saving}>
